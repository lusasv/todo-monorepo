...
Platform documentation is stored at `/Users/user/tmp/_squad_remote/run-385/repo/docs/`. This is OUTSIDE the repository — it will not conflict with the repo's own files.
Instruct agents to use absolute paths when reading or writing these docs.

**Available docs:**
- `/Users/user/tmp/_squad_remote/run-385/repo/docs/ARCHITECTURE.md` — system architecture, components, data flow
- `/Users/user/tmp/_squad_remote/run-385/repo/docs/CONVENTIONS.md` — coding patterns and naming standards
- `/Users/user/tmp/_squad_remote/run-385/repo/docs/API.md` — API endpoints documentation
- `/Users/user/tmp/_squad_remote/run-385/repo/docs/DECISIONS.md` — architecture decision log (append-only)
- Check `ls /Users/user/tmp/_squad_remote/run-385/repo/docs/` for additional docs and subdirectories

**Rules for agents:**
- **Before coding:** instruct Backend/Frontend agents to read `/Users/user/tmp/_squad_remote/run-385/repo/docs/CONVENTIONS.md`
- **After architectural decisions:** instruct agents to append to `/Users/user/tmp/_squad_remote/run-385/repo/docs/DECISIONS.md` with date, decision, and rationale
- **After new APIs:** instruct Backend agent to update `/Users/user/tmp/_squad_remote/run-385/repo/docs/API.md`
